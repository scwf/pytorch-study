...
# 感知机模型、线性回归模型、softmax回归模型这几个基础模型的定义、区别
...
# 很多经典的论文，模型效果很好，一开始找的解释理由都是错的。神经网络其实是一个工程，是一个实验科学，一半工程一半艺术。可能你发现一个好的神经网络模型，背后的why可能50年后有人研究出来了
